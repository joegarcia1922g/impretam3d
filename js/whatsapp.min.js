(() => {
  let popupOpen = false;
  const p = "528334318725", // Número de WhatsApp actualizado con lada de México
  ...
  addEventListener("click", (e) => {
    ...
    form.onsubmit = (e) => {
      ...
      const text = `Hola buen día. Quiero cotizar\n\n*Nombre:* ${name}\n*Teléfono:* ${phone}\n*Mensaje:* ${msg}`;
      closePopup();
